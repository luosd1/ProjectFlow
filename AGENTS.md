...
| 6 | Frontend Shell, Onboarding, Workspace, and Intake | 进行中：2026-05-29 / GitHub #6 |
| 3 | Agent Core Flow: LLM client, Coordinator, Clarification, Planning, Breakdown | - |
| 4 | Assignment Flow: Proposal, Response, Negotiation | - |
| 5 | Active Push + Check-in | - |
| 6 | Risk + Replan + Timeline | - |
| 7 | Demo Polish: seed data, reset, 动画, Agent loading, export | 2026-06-07 |
