...
| 28 | Frontend Redesign Migration: 三栏项目布局(sidebar+content+agent sidebar), 蓝金视觉体系(Instrument Serif+Inter字体), workspace 路由改为跳转项目, AppShell 全高布局, 新组件(project-layout/sidebar/content/agent-sidebar/new-project-dialog/workspace-content/compact-stat/direction-decision-view) | 进行中：2026-06-04 |
