...
def seed_demo_data(session: Session) -> dict:
    ...
    direction_card = json.dumps({
        ...
        "target_users": "大学生项目小队（3-8人）",
        "core_value": "AI Agent 主动推进项目，持续回答下一步做什么、谁适合做、哪些有风险",
        "deliverables": ["MVP demo", "README", "demo video", "review summary"],
        "constraints": ["6周时间", "本地演示优先", "单 workspace"],
        "out_of_scope": ["多团队支持", "正式认证", "生产部署"],
        "initial_risks": ["Agent 输出不稳定", "前后端联调困难", "演示翻车"],
    })
