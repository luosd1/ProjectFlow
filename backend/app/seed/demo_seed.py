...
def reset_demo_data(session: Session) -> DemoResetRead:
    ...
    project = Project(
        ...
        direction_card={
            ...
            "target_users": "College course project teams",
            "core_value": "Convert current project state into explainable next actions.",
            "deliverables": ["Working demo", "Review summary", "Presentation path"],
            "constraints": ["Local-first", "Mock LLM fallback", "One-week demo window"],
            "out_of_scope": ["Production auth", "Multi-agent runtime"],
            "initial_risks": ["Deadline pressure", "Scope drift"],
        },
