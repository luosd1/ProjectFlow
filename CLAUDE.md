...
├── agent-bridge/            # T41 TypeScript Agent Runtime Sidecar (S3/S5/S6/S7/S8/S9/S10/S11/S12/S13/S14/S16 runtime/tool work 已完成)
│   ├── src/
...
│   └── tests/unit/          # 15 test files, 386 tests
├── frontend/
│   ├── src/
