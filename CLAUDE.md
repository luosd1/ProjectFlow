...
| 22 | Agent Output Quality + Bug Fixes: 全中文输出、成员名/任务名替代 ID、max_tokens 适配推理模型、行动卡归属按 user_id、任务状态更新修复、evidence schema 修复、Bug 记录文档化（docs/T23/T23-C-feedback.md） | 已完成：2026-06-03 |
